...
class RetinaNetEmbeddingHead(RetinaNetClassificationHead):
    ...
    def compute_loss(self, targets, head_outputs, matched_idxs): 
        ...
        for targets_per_image, cls_logits_per_image, matched_idxs_per_image in zip(targets, cls_logits, matched_idxs):
            ...
            input_tensor = torch.tensor(cls_logits_per_image.size()[0], dtype=torch.float64) 
            output_tensor = torch.tensor(targets_per_image['embedding'].size()[0], dtype=torch.float64)
