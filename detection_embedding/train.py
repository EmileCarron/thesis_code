...
class RetinaNetDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        if stage == 'fit' or stage is None:
            ...
            self.train_set, test_set = torch.utils.data.random_split(self.train_set, [3000, len(self.train_set)-3000], generator=torch.Generator().manual_seed(42))
            ...
            self.val_set, test_set = torch.utils.data.random_split(self.val_set, [300, len(self.val_set)-300], generator=torch.Generator().manual_seed(42))
